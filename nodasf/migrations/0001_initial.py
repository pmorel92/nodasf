# Generated by Django 2.1.2 on 2019-07-18 22:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='', upload_to='media/faces')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='nodasf.City')),
                ('county', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='nodasf.County')),
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='nodasf.Issue')),
